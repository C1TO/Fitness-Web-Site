...
@Named("egitmenvalidator")
@SessionScoped
public class EgitmenValidator implements Serializable {
    ...
    public boolean validateUzmanlık(FacesContext fc, UIComponent uı, Object v) {
        ...
        String value = (String) v;
        if (value.equals("")) {
            msgList.add(new FacesMessage("Lütfen Uzmanlık Alanınızı Giriniz  ! "));
            isValid = false;
        } else if (value.length() < 1) {
            msgList.add(new FacesMessage("Uzmanlık Alanı 1'den Küçük Olamaz!"));
            isValid = false;
        }
    ...
    public boolean validateTecrube(FacesContext fc, UIComponent uı, Object v) {
        ...
        String value = (String) v;
        if (value.equals("")) {
            msgList.add(new FacesMessage("Lütfen Tecrübenizi Giriniz  ! "));
            isValid = false;
        } else if (value.length() < 1) {
            msgList.add(new FacesMessage("Tecrübe  Alanı 1'den Küçük Olamaz!"));
            isValid = false;
        }
